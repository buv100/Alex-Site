  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 text-text-muted">
      ...
      <div className="mt-8 space-y-6 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-xl text-text">4. שיתוף עם צדדים שלישיים</h2>
          <p className="mt-2">
            המידע מועבר לספקי תשתית תפעוליים בלבד (אירוח, מסד נתונים, אחסון
            תמונות) ככל שיחוברו, לצורך הפעלת האתר — ולא למכירה לצדדים שלישיים
            לצורכי שיווק. ייתכן שיתוף אם נדרש לפי דין.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            לאדמין, סיסמאות ב־hash). משך השמירה — כל עוד נדרש למטרות שלשמן נאסף,
            או לפי דין.
          </p>
        </section>
